...
def _build(n_classes=3, drop_class=None):
    ...
    model fit on the full class set -- the missing-class scenario.
    """
    ...
    return vm_model, _ds("psi_initial", X_a, y_a), _ds("psi_new", X_b, y_b)
