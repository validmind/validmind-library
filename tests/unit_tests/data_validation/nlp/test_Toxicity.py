...
class TestToxicity(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.df = None
        self.vm_dataset = None
        self.invalid_df = None
        self.invalid_vm_dataset = None
    ...
    def test_toxicity_classification(self):
        ...
        print(f"Non-toxic score: {non_toxic_score}, Toxic score: {toxic_score}, Neutral score: {neutral_score}")

        # Verify toxicity classifications
        self.assertTrue(toxic_score > non_toxic_score)  # Toxic text should have higher score
        self.assertTrue(neutral_score < toxic_score)    # Neutral text should be less toxic
