...
Log in to the [ValidMind Platform](https://app.prod.validmind.ai) and register a sample model:
...
A template predefines sections for your model documentation and provides a general outline to follow:

1. In the model's left sidebar, click **Documents** and select **Development**.
