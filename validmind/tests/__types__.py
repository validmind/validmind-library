...
TestID = Union[
    Literal[
        "validmind.classification.Accuracy",
        "validmind.classification.F1",
        "validmind.classification.Precision",
        "validmind.classification.ROC_AUC",
        "validmind.classification.Recall",
        ...
        "validmind.regression.AdjustedRSquaredScore",
        "validmind.regression.GiniCoefficient",
        "validmind.regression.HuberLoss",
        "validmind.regression.KolmogorovSmirnovStatistic",
        "validmind.regression.MeanAbsoluteError",
        "validmind.regression.MeanAbsolutePercentageError",
        "validmind.regression.MeanBiasDeviation",
        "validmind.regression.MeanSquaredError",
        "validmind.regression.QuantileLoss",
        "validmind.regression.RSquaredScore",
        "validmind.regression.RootMeanSquaredError",
    ],
    str,
]
