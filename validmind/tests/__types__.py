...
TestID = Union[
    Literal[
        ...
        "validmind.scorers.classification.AbsoluteError",
        "validmind.scorers.classification.BrierScore",
        "validmind.scorers.classification.CalibrationError",
        "validmind.scorers.classification.ClassBalance",
        "validmind.scorers.classification.Confidence",
        "validmind.scorers.classification.Correctness",
        "validmind.scorers.classification.LogLoss",
        "validmind.scorers.classification.OutlierScore",
        "validmind.scorers.classification.ProbabilityError",
        "validmind.scorers.classification.Uncertainty",
        "validmind.scorers.llm.deepeval.AnswerRelevancy",
        "validmind.scorers.llm.deepeval.ArgumentCorrectness",
        "validmind.scorers.llm.deepeval.Bias",
        "validmind.scorers.llm.deepeval.ContextualPrecision",
        "validmind.scorers.llm.deepeval.ContextualRecall",
        "validmind.scorers.llm.deepeval.ContextualRelevancy",
        "validmind.scorers.llm.deepeval.Faithfulness",
        "validmind.scorers.llm.deepeval.GEval",
