...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">register_test_provider</span>( <span class="param"> <span class="n">namespace</span><span class="p">:</span> <span class="n">str</span></span>, <span class="param"> <span class="n">test_provider</span><span class="p">:</span> <span class="n">TestProvider</span></span>) <span class="p">-></span> <span class="return-annotation">None</span>:</span> </span> :::
