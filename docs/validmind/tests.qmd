...
- **From BaseError**: [class BaseError{.suffix}](#class-baseerror), [description{.suffix}](#description)
- **From builtins.BaseException**: with_traceback, add_note

### [LoadTestError{.suffix}](#__init__)
...
### [LocalTestProvider{.suffix}](#__init__)
