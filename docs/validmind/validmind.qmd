...
```python
def HyperParametersTuning(model: VMModel, dataset: VMDataset, param_grid: Union = None, scoring: Union = None)
```
...
```python
def build_test_result(outputs: Union, test_id: str, inputs: Dict, params: Union, description: str, generate_description: bool = True, title: Optional = None)
```
...
```python
def run_test(test_id: Union = None, name: Union = None, unit_metrics: Union = None, inputs: Union = None, input_grid: Union = None, params: Union = None, param_grid: Union = None, show: bool = True, generate_description: bool = True, title: Optional = None, kwargs = {}) -> TestResult
```
