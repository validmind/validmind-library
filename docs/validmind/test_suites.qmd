...
<span class="kw">def</span><span class="name">format_dataframe</span>(<span class="param"><span class="n">df</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprAttribute --><!-- DEBUG values: [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}] -->
...
</span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- DEBUG: ExprAttribute --><!-- DEBUG values: [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}] -->
...
<span class="kw">def</span><span class="name">test_id_to_name</span>(<span class="param"><span class="n">test_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
...
</span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">describe_suite</span>(<span class="params"><span class="n">test_suite_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
...
<span class="muted">,</span></span><span class="params"><span class="n">verbose</span><span class="o">=</span><span class="kc">False</span></span>):
...
<span class="kw">def</span><span class="name">get_by_id</span>(<span class="param"><span class="n">test_suite_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">list_suites</span>(<span class="param"><span class="n">pretty</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">bool</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">register_test_suite</span>(<span class="params"><span class="n">suite_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
...
<span class="muted">,</span></span><span class="params"><span class="n">suite</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">TestSuite</span><!-- DEBUG is_mapping: True -->
