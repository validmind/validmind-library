...
<span class="kw">def</span> <span class="name">get_logger</span>(<span class="param"><span class="n">name</span><span class="o"> = </span><span class="kc">'validmind'</span><span class="muted">,</span></span><span class="param"><span class="n">log_level</span><span class="o"> = </span><span class="kc">None</span></span>)</span>
...
<span class="kw">def</span> <span class="name">test_id_to_name</span>(<span class="param"><span class="n">test_id</span><span class="p">:</span><span class="n">str</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-str">str</a><span class="muted">:</span> </span></span>
...
<span class="kw">def</span> <span class="name">describe_suite</span>(<span class="param"><span class="n">test_suite_id</span><span class="p">:</span><span class="n">str</span><span class="muted">,</span></span><span class="param"><span class="n">verbose</span><span class="o"> = </span><span class="kc">False</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_by_id</span>(<span class="param"><span class="n">test_suite_id</span><span class="p">:</span><span class="n">str</span></span>)</span>
...
<span class="kw">def</span> <span class="name">list_suites</span>(<span class="param"><span class="n">pretty</span><span class="p">:</span><span class="n">bool</span><span class="o">=</span><span class="kc">True</span></span>)</span>
...
<span class="kw">def</span> <span class="name">register_test_suite</span>(<span class="param"><span class="n">suite_id</span><span class="p">:</span><span class="n">str</span><span class="muted">,</span></span><span class="param"><span class="n">suite</span><span class="p">:</span><span class="n">TestSuite</span></span>)</span>
...
<span class="kw">class</span> <span class="name">ClassifierDiagnosis</span>()</span>
...
<span class="kw">class</span> <span class="name">ClassifierFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">ClassifierMetrics</span>()</span>
...
<span class="kw">class</span> <span class="name">ClassifierModelValidation</span>()</span>
...
<span class="kw">class</span> <span class="name">ClassifierPerformance</span>()</span>
...
<span class="kw">class</span> <span class="name">ClusterFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">ClusterMetrics</span>()</span>
...
<span class="kw">class</span> <span class="name">ClusterPerformance</span>()</span>
...
<span class="kw">class</span> <span class="name">EmbeddingsFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">EmbeddingsMetrics</span>()</span>
...
<span class="kw">class</span> <span class="name">EmbeddingsPerformance</span>()</span>
...
<span class="kw">class</span> <span class="name">KmeansParametersOptimization</span>()</span>
...
<span class="kw">class</span> <span class="name">LLMClassifierFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">NLPClassifierFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">PromptValidation</span>()</span>
...
<span class="kw">class</span> <span class="name">RegressionFullSuite</span>()</span>
...
<span class="kw">class</span> <span class="name">RegressionMetrics</span>()</span>
...
<span class="kw">class</span> <span class="name">RegressionModelDescription</span>()</span>
...
<span class="kw">class</span> <span class="name">RegressionModelsEvaluation</span>()</span>
...
<span class="kw">class</span> <span class="name">RegressionPerformance</span>()</span>
...
<span class="kw">class</span> <span class="name">SummarizationMetrics</span>()</span>
...
<span class="kw">class</span> <span class="name">TabularDataQuality</span>()</span>
...
<span class="kw">class</span> <span class="name">TabularDataset</span>()</span>
...
<span class="kw">class</span> <span class="name">TabularDatasetDescription</span>()</span>
...
<span class="kw">class</span> <span class="name">TextDataQuality</span>()</span>
...
<span class="kw">class</span> <span class="name">TimeSeriesDataQuality</span>()</span>
...
<span class="kw">class</span> <span class="name">TimeSeriesDataset</span>()</span>
...
<span class="kw">class</span> <span class="name">TimeSeriesModelValidation</span>()</span>
...
<span class="kw">class</span> <span class="name">TimeSeriesMultivariate</span>()</span>
...
<span class="kw">class</span> <span class="name">TimeSeriesUnivariate</span>()</span>
