...
<span class="kw">def</span><span class="name">format_dataframe</span>(<span class="param"><span class="n">df</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span></span>:
