...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">describe_suite</span>( <span class="param"> <span class="n">test_suite_id</span><span class="p">:</span> <span class="n">str</span></span>, <span class="param"> <span class="n">verbose</span> <span class="o">=</span> <span class="kc">False</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">get_by_id</span>(<span class="param"><span class="n">test_suite_id</span><span class="p">:</span> <span class="n">str</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">list_suites</span>(<span class="param"><span class="n">pretty</span><span class="p">:</span> <span class="n">bool</span> <span class="o">=</span> <span class="kc">True</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">register_test_suite</span>( <span class="param"> <span class="n">suite_id</span><span class="p">:</span> <span class="n">str</span></span>, <span class="param"> <span class="n">suite</span><span class="p">:</span> <span class="n">TestSuite</span></span>):</span> </span> :::
