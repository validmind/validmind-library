...
<span class="kw">def</span><span class="name">from_dict</span>(<span class="param"><span class="n">cls</span><span class="muted">,</span></span><span class="param"><span class="n">data</span></span>):
...
<span class="kw">def</span><span class="name">run</span>(<span class="param"><span class="n">send</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">bool</span><span class="o">=</span><span class="kc">True</span><span class="muted">,</span></span><span class="param"><span class="n">fail_fast</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">bool</span><span class="o">=</span><span class="kc">False</span></span>):
...
<span class="kw">def</span><span class="name">summarize</span>(<span class="param"><span class="n">show_link</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">bool</span><span class="o">=</span><span class="kc">True</span></span>):
...
<span class="kw">def</span><span class="name">add_extra_column</span>(<span class="param"><span class="n">column_name</span><span class="muted">,</span></span><span class="param"><span class="n">column_values</span><span class="o">=</span><span class="kc">None</span></span>):
...
<span class="kw">def</span><span class="name">assign_predictions</span>(<span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">prediction_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">prediction_values</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">probability_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">probability_values</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">prediction_probabilities</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">\*\*kwargs</span></span>):
...
<span class="kw">def</span><span class="name">prediction_column</span>(<span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">column_name</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="o">=</span><span class="kc">None</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="nb">str</span></span>:
...
<span class="kw">def</span><span class="name">probability_column</span>(<span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">column_name</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="o">=</span><span class="kc">None</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="nb">str</span></span>:
...
<span class="kw">def</span><span class="name">with_options</span>(<span class="param"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span>:
...
<span class="kw">def</span><span class="name">y_pred</span>(<span class="param"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span></span>:
...
<span class="kw">def</span><span class="name">y_pred_df</span>(<span class="param"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}]}</span></span>:
...
<span class="kw">def</span><span class="name">y_prob</span>(<span class="param"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span></span>:
...
<span class="kw">def</span><span class="name">y_prob_df</span>(<span class="param"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}]}</span></span>:
...
<span class="kw">def</span><span class="name">with_options</span>(<span class="param"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vminput">validmind.vm_models.VMInput</a></span>:
...
<span class="kw">def</span><span class="name">predict</span>(<span class="param"><span class="n">\*args</span><span class="muted">,</span></span><span class="param"><span class="n">\*\*kwargs</span></span>):
...
<span class="kw">def</span><span class="name">predict_proba</span>(<span class="param"><span class="n">\*args</span><span class="muted">,</span></span><span class="param"><span class="n">\*\*kwargs</span></span>):
