...
<span class="kw">class</span> <span class="name">Figure</span>()</span>
...
<span class="kw">class</span> <span class="name">ModelAttributes</span>()</span>
...
<span class="kw">def</span> <span class="name">from_dict</span>(<span class="param"><span class="n">cls</span><span class="muted">,</span></span><span class="param"><span class="n">data</span></span>)</span>
...
<span class="kw">class</span> <span class="name">TestSuite</span>()</span>
...
<span class="kw">def</span> <span class="name">get_default_config</span>(<span class="param"><span class="n">self</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-dict">dict</a><span class="muted">:</span> </span></span>
...
<span class="kw">def</span> <span class="name">num_tests</span>(<span class="param"><span class="n">self</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-int">int</a><span class="muted">:</span> </span></span>
...
<span class="kw">class</span> <span class="name">TestSuiteRunner</span>()</span>
...
<span class="kw">def</span> <span class="name">summarize</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">show_link</span><span class="p">:</span><span class="n">bool</span><span class="o"> = </span><span class="kc">True</span></span>)</span>
...
<span class="kw">class</span> <span class="name">VMDataset</span>()</span>
...
<span class="kw">def</span> <span class="name">add_extra_column</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">column_name</span><span class="muted">,</span></span><span class="param"><span class="n">column_values</span><span class="o"> = </span><span class="kc">None</span></span>)</span>
...
<span class="kw">def</span> <span class="name">assign_predictions</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="p">:</span><span class="n">VMModel</span><span class="muted">,</span></span><span class="param"><span class="n">prediction_column</span><span class="p">:</span><span class="n">str</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">prediction_values</span><span class="p">:</span><span class="n">list</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">probability_column</span><span class="p">:</span><span class="n">str</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">probability_values</span><span class="p">:</span><span class="n">list</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">prediction_probabilities</span><span class="p">:</span><span class="n">list</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">kwargs</span><span class="o"> = </span><span class="kc">{}</span></span>)</span>
...
<span class="kw">def</span> <span class="name">prediction_column</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="p">:</span><span class="n">VMModel</span><span class="muted">,</span></span><span class="param"><span class="n">column_name</span><span class="p">:</span><span class="n">str</span><span class="o"> = </span><span class="kc">None</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-str">str</a><span class="muted">:</span> </span></span>
...
<span class="kw">def</span> <span class="name">y_pred</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-{'cls': 'exprattribute', 'values': [{'cls': 'exprname', 'name': 'np'}, {'cls': 'exprname', 'name': 'ndarray'}]}">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</a><span class="muted">:</span> </span></span>
...
<span class="kw">class</span> <span class="name">VMInput</span>()</span>
...
<span class="kw">def</span> <span class="name">with_options</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">kwargs</span><span class="o"> = </span><span class="kc">{}</span></span>)<span class="p"> → </span><span class="return-annotation"><a href="/reference/validmind/vm_models.html#class-vminput">VMInput</a><span class="muted">:</span> </span></span>
...
<span class="kw">class</span> <span class="name">VMModel</span>()</span>
...
<span class="kw">def</span> <span class="name">predict_proba</span>(<span class="param"><span class="n">self</span><span class="muted">,</span></span><span class="param"><span class="n">args</span><span class="o"> = </span><span class="kc">()</span><span class="muted">,</span></span><span class="param"><span class="n">kwargs</span><span class="o"> = </span><span class="kc">{}</span></span>)</span>
