...
<span class="kw">def</span> <span class="name">get_tests</span>(<span class="param"><span class="n">self</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type -->List\[<!-- types.jinja2 - format_type -->str\]</span>
