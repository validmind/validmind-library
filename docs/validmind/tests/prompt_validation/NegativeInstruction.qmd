...
<span class="kw">def</span> <span class="name">call_model</span>(<span class="param"><span class="n">system_prompt</span><span class="p">:</span><span class="n">str</span><span class="muted">,</span></span><span class="param"><span class="n">user_prompt</span><span class="p">:</span><span class="n">str</span><span class="muted">,</span></span><span class="param"><span class="n">temperature</span><span class="p">:</span><span class="n">float</span><span class="o"> = </span><span class="kc">0.0</span><span class="muted">,</span></span><span class="param"><span class="n">seed</span><span class="p">:</span><span class="n">int</span><span class="o"> = </span><span class="kc">42</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_explanation</span>(<span class="param"><span class="n">response</span><span class="p">:</span><span class="n">str</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_score</span>(<span class="param"><span class="n">response</span><span class="p">:</span><span class="n">str</span></span>)</span>
...
<span class="kw">def</span> <span class="name">NegativeInstruction</span>(<span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">min_threshold</span><span class="o"> = </span><span class="kc">7</span></span>)</span>
