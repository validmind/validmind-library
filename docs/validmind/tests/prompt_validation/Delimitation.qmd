...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('llm', 'zero_shot', 'few_shot')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('text_classification', 'text_summarization')</span></div>
