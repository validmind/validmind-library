...
<span class="kw">def</span> <span class="name">Delimitation</span>(<span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">min_threshold</span><span class="o"> = </span><span class="kc">7</span></span>)</span>
