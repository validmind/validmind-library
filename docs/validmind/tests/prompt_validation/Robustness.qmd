...
<span class="kw">def</span><span class="name">call_model</span>(<span class="param"><span class="n">system_prompt</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="muted">,</span></span><span class="param"><span class="n">user_prompt</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="muted">,</span></span><span class="param"><span class="n">temperature</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="o">=</span><span class="kc">0.0</span><span class="muted">,</span></span><span class="param"><span class="n">seed</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="o">=</span><span class="kc">42</span></span>):
...
<span class="kw">def</span><span class="name">Robustness</span>(<span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">num_tests</span><span class="o">=</span><span class="kc">10</span></span>):
