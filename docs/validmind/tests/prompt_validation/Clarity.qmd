...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">Clarity</span>( <span class="param"> <span class="n">model</span></span>, <span class="param"> <span class="n">min_threshold</span> <span class="o">=</span> <span class="kc">7</span></span>):</span> </span> :::
