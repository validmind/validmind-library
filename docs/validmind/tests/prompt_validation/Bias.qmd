...
<div class="decorator"><span class="n">@tags(<span class="s">'llm'</span>, <span class="s">'few_shot'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'text_classification'</span>, <span class="s">'text_summarization'</span>)</span></div>
