...
<span class="kw">def</span><span class="name">format_records</span>(<span class="param"><span class="n">df</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprAttribute --><!-- DEBUG values: [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}] -->
...
</span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">List</span><!-- DEBUG is_mapping: True -->
...
<div class="decorator">@<!-- types.jinja2 - format_type --><!-- DEBUG: ExprCall --><span class="n">{'arguments': ["'tabular_data'", "'time_series_data'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
...
<span class="kw">def</span><span class="name">DescriptiveStatistics</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">VMDataset</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
</span>):
