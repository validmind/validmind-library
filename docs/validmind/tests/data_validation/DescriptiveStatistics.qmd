...
<span class="kw">def</span><span class="name">format_records</span>(<span class="param"><span class="n">df</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'pd'}, {'cls': 'ExprName', 'name': 'DataFrame'}]}</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- Mapping --><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">List</span><span class="p">\[</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">Dict</span><span class="p">\[</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">Any</span><span class="p">\]</span><span class="p">\]</span></span>:
...
<span class="kw">def</span><span class="name">DescriptiveStatistics</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span></span>):
