...
<div class="decorator"><span class="n">@tags(<span class="s">'tabular_data'</span>, <span class="s">'categorical_data'</span>, <span class="s">'statistical_test'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'classification'</span>)</span></div>
