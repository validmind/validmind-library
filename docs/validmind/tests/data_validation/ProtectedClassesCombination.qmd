...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">ProtectedClassesCombination</span>( <span class="param"> <span class="n">dataset</span></span>, <span class="param"> <span class="n">model</span></span>, <span class="param"> <span class="n">protected_classes</span> <span class="o">=</span> <span class="kc">None</span></span>):</span> </span> :::
