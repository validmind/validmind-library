...
<span class="kw">def</span> <span class="name">get_logger</span>(
    <span class="param"><span class="n">name</span> <span class="o">=</span> <span class="kc">'validmind'</span></span>,    <span class="param"><span class="n">log_level</span> <span class="o">=</span> <span class="kc">None</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">calculate_fairness_metrics</span>(
    <span class="param"><span class="n">test_df</span></span>,    <span class="param"><span class="n">target</span></span>,    <span class="param"><span class="n">y_pred_opt</span></span>,    <span class="param"><span class="n">protected_classes</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">calculate_group_metrics</span>(
    <span class="param"><span class="n">test_df</span></span>,    <span class="param"><span class="n">target</span></span>,    <span class="param"><span class="n">y_pred_opt</span></span>,    <span class="param"><span class="n">protected_classes</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">initialize_and_fit_optimizer</span>(
    <span class="param"><span class="n">pipeline</span></span>,    <span class="param"><span class="n">X_train</span></span>,    <span class="param"><span class="n">y_train</span></span>,    <span class="param"><span class="n">protected_classes_df</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">make_predictions</span>(
    <span class="param"><span class="n">threshold_optimizer</span></span>,    <span class="param"><span class="n">test_df</span></span>,    <span class="param"><span class="n">protected_classes</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">ProtectedClassesThresholdOptimizer</span>(
