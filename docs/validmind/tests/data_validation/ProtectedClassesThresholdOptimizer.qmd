...
<span class="kw">def</span> <span class="name">calculate_fairness_metrics</span>(<span class="param"><span class="n">test_df</span><span class="muted">,</span></span><span class="param"><span class="n">target</span><span class="muted">,</span></span><span class="param"><span class="n">y_pred_opt</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_thresholds_by_group</span>(<span class="param"><span class="n">threshold_optimizer</span></span>)</span>
...
<span class="kw">def</span> <span class="name">initialize_and_fit_optimizer</span>(<span class="param"><span class="n">pipeline</span><span class="muted">,</span></span><span class="param"><span class="n">X_train</span><span class="muted">,</span></span><span class="param"><span class="n">y_train</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes_df</span></span>)</span>
...
<span class="kw">def</span> <span class="name">make_predictions</span>(<span class="param"><span class="n">threshold_optimizer</span><span class="muted">,</span></span><span class="param"><span class="n">test_df</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes</span></span>)</span>
...
<span class="kw">def</span> <span class="name">plot_thresholds</span>(<span class="param"><span class="n">threshold_optimizer</span></span>)</span>
...
<span class="kw">def</span> <span class="name">ProtectedClassesThresholdOptimizer</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">pipeline</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">X_train</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">y_train</span><span class="o"> = </span><span class="kc">None</span></span>)</span>
