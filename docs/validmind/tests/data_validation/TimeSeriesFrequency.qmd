...
<span class="kw">def</span> <span class="name">TimeSeriesFrequency</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><span class="n">VMDataset</span></span>)</span>
