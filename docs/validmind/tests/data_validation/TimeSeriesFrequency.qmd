...
<div class="decorator"><span class="n">@tags(<span class="s">'time_series_data'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>)</span></div>
