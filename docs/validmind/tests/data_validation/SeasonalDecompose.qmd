...
<span class="kw">def</span><span class="name">SeasonalDecompose</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">seasonal_model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="o">=</span><span class="s1">'additive'</span></span>):
