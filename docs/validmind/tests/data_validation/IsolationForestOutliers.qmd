...
<span class="kw">def</span><span class="name">IsolationForestOutliers</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">random_state</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="o">=</span><span class="kc">0</span><span class="muted">,</span></span><span class="param"><span class="n">contamination</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="o">=</span><span class="kc">0.1</span><span class="muted">,</span></span><span class="param"><span class="n">feature_columns</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">list</span><span class="o">=</span><span class="kc">None</span></span>):
