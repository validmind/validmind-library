...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('time_series_data', 'stationarity', 'unit_root_test', 'statsmodels')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('data_validation')</span></div>
