...
<div class="decorator"><span class="n">@tags(<span class="s">'time_series_data'</span>, <span class="s">'stationarity'</span>, <span class="s">'unit_root_test'</span>, <span class="s">'statsmodels'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'data_validation'</span>)</span></div>
