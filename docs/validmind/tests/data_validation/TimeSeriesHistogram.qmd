...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('data_validation', 'visualization', 'time_series_data')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression', 'time_series_forecasting')</span></div>
