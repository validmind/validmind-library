...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">TimeSeriesHistogram</span>( <span class="param"> <span class="n">dataset</span></span>, <span class="param"> <span class="n">nbins</span> <span class="o">=</span> <span class="kc">30</span></span>):</span> </span> :::
