...
<div class="decorator"><span class="n">@tags(<span class="s">'data_validation'</span>, <span class="s">'visualization'</span>, <span class="s">'time_series_data'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>, <span class="s">'time_series_forecasting'</span>)</span></div>
