...
<div class="decorator">@<!-- types.jinja2 - format_type --><!-- DEBUG: ExprCall --><span class="n">{'arguments': ["'time_series_data'", "'statistical_test'", "'forecasting'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">EngleGrangerCoint</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">VMDataset</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
