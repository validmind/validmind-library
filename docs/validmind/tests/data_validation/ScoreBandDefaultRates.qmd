...
<div class="decorator"><span class="n">@tags(<span class="s">'visualization'</span>, <span class="s">'credit_risk'</span>, <span class="s">'scorecard'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'classification'</span>)</span></div>
