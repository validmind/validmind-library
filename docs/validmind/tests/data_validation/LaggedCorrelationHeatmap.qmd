...
<span class="kw">def</span> <span class="name">LaggedCorrelationHeatmap</span>(
    <span class="param"><span class="n">dataset</span><span class="p">:</span> <span class="n">VMDataset</span></span>,    <span class="param"><span class="n">num_lags</span><span class="p">:</span> <span class="n">int</span> <span class="o">=</span> <span class="kc">10</span></span>):</span>
</span>
