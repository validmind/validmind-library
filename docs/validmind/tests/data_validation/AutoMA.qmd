...
<span class="signature">
<span class="kw">def</span> <span class="name">AutoMA</span>(
    <span class="param"><span class="n">dataset</span><span class="p">:</span> <span class="n">VMDataset</span></span>,    <span class="param"><span class="n">max_ma_order</span><span class="p">:</span> <span class="n">int</span> <span class="o">=</span> <span class="kc">3</span></span>):</span>
</span>
