...
<span class="kw">def</span><span class="name">plot_rolling_statistics</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">col</span><span class="muted">,</span></span><span class="param"><span class="n">window_size</span></span>):
...
<span class="kw">def</span><span class="name">RollingStatsPlot</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">window_size</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="o">=</span><span class="kc">12</span></span>):
