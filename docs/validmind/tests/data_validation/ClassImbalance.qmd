...
<span class="kw">def</span><span class="name">ClassImbalance</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">min_percent_threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="o">=</span><span class="kc">10</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Tuple</span><span class="p">[</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Dict</span><span class="p">[</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">Any</span><span class="p">]</span><span class="p">, </span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="s">"{\u0027cls\u0027: \u0027ExprAttribute\u0027, \u0027values\u0027: [{\u0027cls\u0027: \u0027ExprName\u0027, \u0027name\u0027: \u0027go\u0027}, {\u0027cls\u0027: \u0027ExprName\u0027, \u0027name\u0027: \u0027Figure\u0027}]}"</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="nb">bool</span><span class="p">]</span></span>:
