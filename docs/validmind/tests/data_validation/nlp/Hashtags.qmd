...
<span class="kw">def</span><span class="name">Hashtags</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">top_hashtags</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">int</span><span class="o">=</span><span class="kc">25</span></span>):
