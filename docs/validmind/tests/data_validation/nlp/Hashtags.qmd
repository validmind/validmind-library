...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('nlp', 'text_data', 'visualization', 'frequency_analysis')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('text_classification', 'text_summarization')</span></div>
