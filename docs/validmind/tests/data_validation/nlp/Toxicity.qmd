...
<div class="decorator"><span class="n">@tags(<span class="s">'nlp'</span>, <span class="s">'text_data'</span>, <span class="s">'data_validation'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'nlp'</span>)</span></div>
