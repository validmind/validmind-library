...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'nlp'", "'text_data'", "'data_validation'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'nlp'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tasks'}}</span></div>
