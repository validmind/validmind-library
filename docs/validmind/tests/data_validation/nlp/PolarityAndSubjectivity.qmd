...
<span class="kw">def</span> <span class="name">PolarityAndSubjectivity</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">threshold_subjectivity</span><span class="o"> = </span><span class="kc">0.5</span><span class="muted">,</span></span><span class="param"><span class="n">threshold_polarity</span><span class="o"> = </span><span class="kc">0</span></span>)</span>
