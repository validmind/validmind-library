...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('nlp', 'text_data', 'data_validation')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('nlp')</span></div>
