...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'nlp'", "'text_data'", "'visualization'", "'frequency_analysis'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'text_classification'", "'text_summarization'", "'nlp'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tasks'}}</span></div>
