...
<span class="kw">def</span><span class="name">TextDescription</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">unwanted_tokens</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">set</span><span class="o">=</span><span class="kc">{'cls': 'ExprSet', 'elements': ["'s'", '"s'"', "'mr'", "'ms'", "'mrs'", "'dr'", '"'s"', "' '", '"''"', "'dollar'", "'us'", "'\`\`'"]}</span><span class="muted">,</span></span><span class="params"><span class="n">lang</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">str</span><span class="o">=</span><span class="s1">'english'</span></span>):
