...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">create_metrics_df</span>( <span class="param"> <span class="n">df</span></span>, <span class="param"> <span class="n">text_column</span></span>, <span class="param"> <span class="n">unwanted_tokens</span></span>, <span class="param"> <span class="n">lang</span></span>):</span> </span> :::

## TextDescription[()]{.muted}

<!-- function.qmd.jinja2 - function signature -->

::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">TextDescription</span>( <span class="param"> <span class="n">dataset</span><span class="p">:</span> <span class="n">VMDataset</span></span>, <span class="param"> <span class="n">unwanted_tokens</span><span class="p">:</span> <span class="n">set</span> <span class="o">=</span> <span class="kc">{'cls': 'ExprSet', 'elements': ["'s'", '"s'"', "'mr'", "'ms'", "'mrs'", "'dr'", '"'s"', "' '", '"''"', "'dollar'", "'us'", "'\`\`'"]}</span></span>, <span class="param"> <span class="n">lang</span><span class="p">:</span> <span class="n">str</span> <span class="o">=</span> <span class="kc">'english'</span></span>):</span> </span> :::
