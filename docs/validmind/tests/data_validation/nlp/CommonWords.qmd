...
<span class="kw">def</span> <span class="name">CommonWords</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span></span>)
