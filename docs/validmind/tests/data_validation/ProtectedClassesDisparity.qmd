...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('bias_and_fairness')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
