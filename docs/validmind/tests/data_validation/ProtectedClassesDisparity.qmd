...
<span class="kw">def</span> <span class="name">ProtectedClassesDisparity</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">disparity_tolerance</span><span class="o"> = </span><span class="kc">1.25</span><span class="muted">,</span></span><span class="param"><span class="n">metrics</span><span class="o"> = </span><span class="kc">{'cls': 'ExprList', 'elements': ["'fnr'", "'fpr'", "'tpr'"]}</span></span>)</span>
