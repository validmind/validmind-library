...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('feature_selection', 'data_analysis')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
