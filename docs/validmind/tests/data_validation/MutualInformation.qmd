...
<div class="decorator"><span class="n">@tags(<span class="s">'feature_selection'</span>, <span class="s">'data_analysis'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'classification'</span>, <span class="s">'regression'</span>)</span></div>
