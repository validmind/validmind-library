...
<span class="kw">def</span><span class="name">DatasetDescription</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span>):
...
<span class="kw">def</span><span class="name">describe_column</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span></span>):
...
<span class="kw">def</span><span class="name">get_column_histograms</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span><span class="muted">,</span></span><span class="param"><span class="n">type\_</span></span>):
...
<span class="kw">def</span><span class="name">get_numerical_histograms</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span></span>):
