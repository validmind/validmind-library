...
<span class="kw">def</span> <span class="name">DatasetDescription</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><span class="n">VMDataset</span></span>)</span>
...
<span class="kw">def</span> <span class="name">describe_column</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_column_histograms</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span><span class="muted">,</span></span><span class="param"><span class="n">type\_</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_numerical_histograms</span>(<span class="param"><span class="n">df</span><span class="muted">,</span></span><span class="param"><span class="n">column</span></span>)</span>
...
<span class="kw">def</span> <span class="name">infer_datatypes</span>(<span class="param"><span class="n">df</span></span>)</span>
