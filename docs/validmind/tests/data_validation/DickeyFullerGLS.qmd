...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('time_series_data', 'forecasting', 'unit_root_test')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression')</span></div>
