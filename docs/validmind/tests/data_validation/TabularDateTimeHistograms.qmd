...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('time_series_data', 'visualization')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
