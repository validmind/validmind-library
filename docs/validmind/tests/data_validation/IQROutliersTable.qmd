...
<span class="kw">def</span><span class="name">compute_outliers</span>(<span class="param"><span class="n">series</span><span class="muted">,</span></span><span class="param"><span class="n">threshold</span><span class="o">=</span><span class="kc">1.5</span></span>):
