...
<span class="kw">def</span><span class="name">ProtectedClassesDescription</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">protected_classes</span><span class="o">=</span><span class="kc">None</span></span>):
