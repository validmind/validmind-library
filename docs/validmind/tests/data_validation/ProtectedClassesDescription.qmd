...
<div class="decorator"><span class="n">@tags(<span class="s">'bias_and_fairness'</span>, <span class="s">'descriptive_statistics'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'classification'</span>, <span class="s">'regression'</span>)</span></div>
