...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('data_quality', 'tabular_data')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
