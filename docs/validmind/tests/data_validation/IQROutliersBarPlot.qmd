...
<span class="kw">def</span><span class="name">compute_outliers</span>(<span class="param"><span class="n">series</span><span class="muted">,</span></span><span class="param"><span class="n">threshold</span></span>):
...
<span class="kw">def</span><span class="name">IQROutliersBarPlot</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="o">=</span><span class="kc">1.5</span><span class="muted">,</span></span><span class="param"><span class="n">fig_width</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="o">=</span><span class="kc">800</span></span>):
