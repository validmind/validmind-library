...
<span class="kw">def</span> <span class="name">get_categorical_columns</span>(<span class="param"><span class="n">dataset</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_datetime_columns</span>(<span class="param"><span class="n">dataset</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_numerical_columns</span>(<span class="param"><span class="n">dataset</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_summary_statistics_categorical</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">categorical_fields</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_summary_statistics_datetime</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">datetime_fields</span></span>)</span>
...
<span class="kw">def</span> <span class="name">get_summary_statistics_numerical</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">numerical_fields</span></span>)</span>
...
<span class="kw">def</span> <span class="name">TabularDescriptionTables</span>(<span class="param"><span class="n">dataset</span></span>)</span>
