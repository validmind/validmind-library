...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('tabular_data')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
