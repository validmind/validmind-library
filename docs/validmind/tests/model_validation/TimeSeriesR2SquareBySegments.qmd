...
<span class="kw">def</span> <span class="name">TimeSeriesR2SquareBySegments</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">segments</span><span class="o"> = </span><span class="kc">None</span></span>)</span>
