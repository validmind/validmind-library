...
<div class="decorator"><span class="n">@tags(<span class="s">'regression'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'residual_analysis'</span>, <span class="s">'visualization'</span>)</span></div>
