...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">ModelPredictionResiduals</span>( <span class="param"> <span class="n">dataset</span></span>, <span class="param"> <span class="n">model</span></span>, <span class="param"> <span class="n">nbins</span> <span class="o">=</span> <span class="kc">100</span></span>, <span class="param"> <span class="n">p_value_threshold</span> <span class="o">=</span> <span class="kc">0.05</span></span>, <span class="param"> <span class="n">start_date</span> <span class="o">=</span> <span class="kc">None</span></span>, <span class="param"> <span class="n">end_date</span> <span class="o">=</span> <span class="kc">None</span></span>):</span> </span> :::
