...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('regression')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('residual_analysis', 'visualization')</span></div>
