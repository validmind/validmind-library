...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'model_training'", "'metadata'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'regression'", "'time_series_forecasting'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tasks'}}</span></div>
