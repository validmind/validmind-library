...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('model_training', 'metadata')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression', 'time_series_forecasting')</span></div>
