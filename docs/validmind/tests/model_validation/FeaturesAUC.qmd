...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('feature_importance', 'AUC', 'visualization')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification')</span></div>
