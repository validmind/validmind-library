...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('model_performance', 'visualization')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression')</span></div>
