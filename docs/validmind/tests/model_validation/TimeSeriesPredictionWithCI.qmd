...
<div class="decorator"><span class="n">@tags(<span class="s">'model_predictions'</span>, <span class="s">'visualization'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>, <span class="s">'time_series_forecasting'</span>)</span></div>
