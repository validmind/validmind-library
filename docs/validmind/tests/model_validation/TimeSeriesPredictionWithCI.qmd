...
<span class="kw">def</span> <span class="name">TimeSeriesPredictionWithCI</span>(
    <span class="param"><span class="n">dataset</span></span>,    <span class="param"><span class="n">model</span></span>,    <span class="param"><span class="n">confidence</span> <span class="o">=</span> <span class="kc">0.95</span></span>):</span>
</span>
