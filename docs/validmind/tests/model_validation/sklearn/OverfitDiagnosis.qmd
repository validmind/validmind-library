...
<span class="kw">def</span><span class="name">OverfitDiagnosis</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">datasets</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">List</span><span class="p">\[</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span><span class="p">\]</span><span class="muted">,</span></span><span class="params"><span class="n">metric</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">cut_off_threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">float</span><span class="o">=</span><span class="kc">{'cls': 'ExprName', 'name': 'DEFAULT_THRESHOLD'}</span></span>):
