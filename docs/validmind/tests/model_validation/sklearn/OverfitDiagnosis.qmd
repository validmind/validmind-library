...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('sklearn', 'binary_classification', 'multiclass_classification', 'linear_regression', 'model_diagnosis')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'regression')</span></div>
