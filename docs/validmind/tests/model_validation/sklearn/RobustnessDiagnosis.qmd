...
<div class="decorator">@<!-- types.jinja2 - format_type --><!-- DEBUG: ExprCall --><span class="n">{'arguments': ["'sklearn'", "'model_diagnosis'", "'visualization'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">RobustnessDiagnosis</span>(<span class="params"><span class="n">datasets</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">List</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
...
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="muted">,</span></span><span class="params"><span class="n">metric</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">scaling_factor_std_dev_list</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">List</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
...
<!-- DEBUG cls_value: ExprSubscript -->
<!-- DEBUG cls_type: str -->
<span class="o">=</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">DEFAULT_STD_DEV_LIST</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="muted">,</span></span><span class="params"><span class="n">performance_decay_threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">float</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="o">=</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">DEFAULT_DECAY_THRESHOLD</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
</span>):
