...
<span class="kw">def</span> <span class="name">RegressionErrors</span>(<span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">dataset</span></span>)</span>
