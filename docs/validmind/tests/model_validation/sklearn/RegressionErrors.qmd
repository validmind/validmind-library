...
<div class="decorator"><span class="n">@tags(<span class="s">'sklearn'</span>, <span class="s">'model_performance'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>, <span class="s">'classification'</span>)</span></div>
