...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'sklearn'", "'model_performance'", "'classification'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">{'arguments': ["'classification'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tasks'}}</span></div>
