...
<div class="decorator"><span class="n">@tags(<span class="s">'sklearn'</span>, <span class="s">'model_performance'</span>, <span class="s">'clustering'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'clustering'</span>)</span></div>
