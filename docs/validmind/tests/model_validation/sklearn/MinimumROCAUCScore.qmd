...
<span class="kw">def</span><span class="name">MinimumROCAUCScore</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">VMDataset</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
...
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="o">=</span><span class="kc">0.5</span></span>):
