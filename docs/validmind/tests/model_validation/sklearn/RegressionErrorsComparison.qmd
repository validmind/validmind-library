...
<span class="kw">def</span><span class="name">RegressionErrorsComparison</span>(<span class="param"><span class="n">datasets</span><span class="muted">,</span></span><span class="param"><span class="n">models</span></span>):
