...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">generate_shap_plot</span>( <span class="param"> <span class="n">type\_</span></span>, <span class="param"> <span class="n">shap_values</span></span>, <span class="param"> <span class="n">x_test</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">select_shap_values</span>( <span class="param"> <span class="n">shap_values</span></span>, <span class="param"> <span class="n">class_of_interest</span></span>):</span> </span> :::
