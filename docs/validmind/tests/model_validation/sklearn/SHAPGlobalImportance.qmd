...
<span class="kw">def</span><span class="name">get_logger</span>(<span class="param"><span class="n">name</span><span class="o">=</span><span class="s1">'validmind'</span><span class="muted">,</span></span><span class="param"><span class="n">log_level</span><span class="o">=</span><span class="kc">None</span></span>):
...
<span class="kw">def</span><span class="name">generate_shap_plot</span>(<span class="param"><span class="n">type\_</span><span class="muted">,</span></span><span class="param"><span class="n">shap_values</span><span class="muted">,</span></span><span class="param"><span class="n">x_test</span></span>):
...
<span class="kw">def</span><span class="name">select_shap_values</span>(<span class="param"><span class="n">shap_values</span><span class="muted">,</span></span><span class="param"><span class="n">class_of_interest</span></span>):
