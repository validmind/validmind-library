...
<span class="kw">def</span> <span class="name">generate_shap_plot</span>(<span class="param"><span class="n">type\_</span><span class="muted">,</span></span><span class="param"><span class="n">shap_values</span><span class="muted">,</span></span><span class="param"><span class="n">x_test</span></span>)</span>
...
<span class="kw">def</span> <span class="name">select_shap_values</span>(<span class="param"><span class="n">shap_values</span><span class="muted">,</span></span><span class="param"><span class="n">class_of_interest</span></span>)</span>
...
<span class="kw">def</span> <span class="name">SHAPGlobalImportance</span>(<span class="param"><span class="n">model</span><span class="p">:</span><span class="n">VMModel</span><span class="muted">,</span></span><span class="param"><span class="n">dataset</span><span class="p">:</span><span class="n">VMDataset</span><span class="muted">,</span></span><span class="param"><span class="n">kernel_explainer_samples</span><span class="p">:</span><span class="n">int</span><span class="o"> = </span><span class="kc">10</span><span class="muted">,</span></span><span class="param"><span class="n">tree_or_linear_explainer_samples</span><span class="p">:</span><span class="n">int</span><span class="o"> = </span><span class="kc">200</span><span class="muted">,</span></span><span class="param"><span class="n">class_of_interest</span><span class="p">:</span><span class="n">int</span><span class="o"> = </span><span class="kc">None</span></span>)</span>
