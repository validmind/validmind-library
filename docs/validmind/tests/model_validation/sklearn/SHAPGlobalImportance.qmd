...
- **class_of_interest**: The class index for which to retrieve SHAP values. If None (default: (default, the function will assume binary classification and use class 1 by default.)
