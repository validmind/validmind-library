...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('sklearn', 'binary_classification', 'multiclass_classification', 'feature_importance', 'visualization')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification', 'text_classification')</span></div>
