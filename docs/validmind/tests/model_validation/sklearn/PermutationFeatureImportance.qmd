...
<div class="decorator">@<!-- types.jinja2 - format_type --><!-- DEBUG: ExprCall --><span class="n">{'arguments': ["'sklearn'", "'binary_classification'", "'multiclass_classification'", "'feature_importance'", "'visualization'"], 'cls': 'ExprCall', 'function': {'cls': 'ExprName', 'name': 'tags'}}</span><!-- DEBUG is_mapping: True -->
...
<span class="kw">def</span><span class="name">PermutationFeatureImportance</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">VMModel</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
...
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="muted">,</span></span><span class="params"><span class="n">fontsize</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">Union</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="p">[</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">int</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
...
<!-- DEBUG cls_type: str -->
<span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">figure_height</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">Union</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="p">[</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">int</span><!-- DEBUG is_mapping: True -->
