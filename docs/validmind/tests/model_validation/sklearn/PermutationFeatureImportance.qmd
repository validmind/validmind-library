...
<span class="kw">def</span><span class="name">PermutationFeatureImportance</span>(<span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">fontsize</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">None</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">figure_height</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">int</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">None</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span></span>):
