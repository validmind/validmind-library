...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">ClassifierPerformance</span>( <span class="param"> <span class="n">dataset</span><span class="p">:</span> <span class="n">VMDataset</span></span>, <span class="param"> <span class="n">model</span><span class="p">:</span> <span class="n">VMModel</span></span>, <span class="param"> <span class="n">average</span><span class="p">:</span> <span class="n">str</span> <span class="o">=</span> <span class="kc">'macro'</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">multiclass_roc_auc_score</span>( <span class="param"> <span class="n">y_test</span></span>, <span class="param"> <span class="n">y_pred</span></span>, <span class="param"> <span class="n">average</span> <span class="o">=</span> <span class="kc">'macro'</span></span>):</span> </span> :::
