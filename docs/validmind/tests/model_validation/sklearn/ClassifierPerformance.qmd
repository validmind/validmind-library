...
<span class="kw">def</span><span class="name">multiclass_roc_auc_score</span>(<span class="param"><span class="n">y_test</span><span class="muted">,</span></span><span class="param"><span class="n">y_pred</span><span class="muted">,</span></span><span class="param"><span class="n">average</span><span class="o">=</span><span class="s1">'macro'</span></span>):
