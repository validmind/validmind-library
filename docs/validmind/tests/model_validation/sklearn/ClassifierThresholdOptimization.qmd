...
<span class="kw">def</span> <span class="name">ClassifierThresholdOptimization</span>(
...
<span class="signature">
<span class="kw">def</span> <span class="name">find_optimal_threshold</span>(
    <span class="param"><span class="n">y_true</span></span>,    <span class="param"><span class="n">y_prob</span></span>,    <span class="param"><span class="n">method</span> <span class="o">=</span> <span class="kc">'youden'</span></span>,    <span class="param"><span class="n">target_recall</span> <span class="o">=</span> <span class="kc">None</span></span>):</span>
</span>
