...
<span class="kw">def</span><span class="name">MinimumF1Score</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">min_threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">float</span><span class="o">=</span><span class="kc">0.5</span></span>):
