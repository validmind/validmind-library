...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">calculate_psi</span>( <span class="param"> <span class="n">score_initial</span></span>, <span class="param"> <span class="n">score_new</span></span>, <span class="param"> <span class="n">num_bins</span> <span class="o">=</span> <span class="kc">10</span></span>, <span class="param"> <span class="n">mode</span> <span class="o">=</span> <span class="kc">'fixed'</span></span>):</span> </span> :::
