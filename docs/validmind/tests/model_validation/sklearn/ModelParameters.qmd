...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">ModelParameters</span>( <span class="param"> <span class="n">model</span></span>, <span class="param"> <span class="n">model_params</span> <span class="o">=</span> <span class="kc">None</span></span>):</span> </span> :::
