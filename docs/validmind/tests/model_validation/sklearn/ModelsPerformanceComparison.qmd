...
<span class="kw">def</span> <span class="name">multiclass_roc_auc_score</span>(
    <span class="param"><span class="n">y_test</span></span>,    <span class="param"><span class="n">y_pred</span></span>,    <span class="param"><span class="n">average</span> <span class="o">=</span> <span class="kc">'macro'</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">ModelsPerformanceComparison</span>(
    <span class="param"><span class="n">dataset</span><span class="p">:</span> <span class="n">VMDataset</span></span>,    <span class="param"><span class="n">models</span><span class="p">:</span> <span class="n">{'cls': 'ExprSubscript', 'left': {'cls': 'ExprName', 'name': 'list'}, 'slice': {'cls': 'ExprName', 'name': 'VMModel'}}</span></span>):</span>
</span>
