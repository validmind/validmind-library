...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('sklearn', 'model_performance', 'kmeans')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('clustering')</span></div>
