...
<span class="kw">def</span> <span class="name">custom_recall</span>(
    <span class="param"><span class="n">y_true</span></span>,    <span class="param"><span class="n">y_pred_proba</span></span>,    <span class="param"><span class="n">threshold</span> <span class="o">=</span> <span class="kc">0.5</span></span>):</span>
</span>
...
<span class="signature">
<span class="kw">def</span> <span class="name">HyperParametersTuning</span>(
