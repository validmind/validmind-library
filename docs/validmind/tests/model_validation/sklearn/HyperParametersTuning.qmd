...
<span class="kw">def</span><span class="name">custom_recall</span>(<span class="param"><span class="n">y_true</span><span class="muted">,</span></span><span class="param"><span class="n">y_pred_proba</span><span class="muted">,</span></span><span class="param"><span class="n">threshold</span><span class="o">=</span><span class="kc">0.5</span></span>):
...
<span class="kw">def</span><span class="name">HyperParametersTuning</span>(<span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">param_grid</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">dict</span><span class="muted">,</span></span><span class="param"><span class="n">scoring</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">List</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">Dict</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">thresholds</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="p">, </span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">List</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="p">\]</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="param"><span class="n">fit_params</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="nb">dict</span><span class="o">=</span><span class="kc">None</span></span>):
