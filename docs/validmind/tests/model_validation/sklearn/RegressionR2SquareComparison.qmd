...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('model_performance', 'sklearn')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression', 'time_series_forecasting')</span></div>
