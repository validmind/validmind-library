...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">RegressionR2SquareComparison</span>( <span class="param"> <span class="n">datasets</span></span>, <span class="param"> <span class="n">models</span></span>):</span> </span> :::
