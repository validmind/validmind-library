...
<div class="decorator"><span class="n">@tags(<span class="s">'statsmodels'</span>, <span class="s">'feature_importance'</span>, <span class="s">'visualization'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>)</span></div>
