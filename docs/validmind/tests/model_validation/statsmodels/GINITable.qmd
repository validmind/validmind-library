...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">GINITable</span>( <span class="param"> <span class="n">dataset</span></span>, <span class="param"> <span class="n">model</span></span>):</span> </span> :::
