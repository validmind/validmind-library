...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('tabular_data', 'visualization', 'model_training')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression')</span></div>
