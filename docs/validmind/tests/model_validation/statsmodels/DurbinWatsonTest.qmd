...
<span class="kw">def</span> <span class="name">DurbinWatsonTest</span>(<span class="param"><span class="n">dataset</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="muted">,</span></span><span class="param"><span class="n">threshold</span><span class="o"> = </span><span class="kc">{'cls': 'ExprList', 'elements': ['1.5', '2.5']}</span></span>)</span>
