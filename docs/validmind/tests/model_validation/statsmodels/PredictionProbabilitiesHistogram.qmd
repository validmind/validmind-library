...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">PredictionProbabilitiesHistogram</span>( <span class="param"> <span class="n">dataset</span></span>, <span class="param"> <span class="n">model</span></span>, <span class="param"> <span class="n">title</span> <span class="o">=</span> <span class="kc">'Histogram of Predictive Probabilities'</span></span>):</span> </span> :::
