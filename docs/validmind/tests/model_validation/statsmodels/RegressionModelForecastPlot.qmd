...
<span class="kw">def</span><span class="name">RegressionModelForecastPlot</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">VMModel</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
...
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="muted">,</span></span><span class="params"><span class="n">start_date</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">Union</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
...
<!-- DEBUG cls_type: str -->
<span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">end_date</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprSubscript --><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="n">Union</span><!-- DEBUG is_mapping: True -->
<!-- DEBUG type_class: dict -->
<!-- DEBUG cls_value: ExprName -->
<!-- DEBUG cls_type: str -->
<span class="p">[</span><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">str</span><!-- DEBUG is_mapping: True -->
