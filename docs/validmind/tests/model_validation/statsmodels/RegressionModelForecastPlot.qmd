...
<span class="kw">def</span><span class="name">RegressionModelForecastPlot</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">start_date</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">None</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">end_date</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">None</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span></span>):
