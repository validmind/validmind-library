...
<div class="decorator"><span class="n">@tags(<span class="s">'statistical_test'</span>, <span class="s">'model_interpretation'</span>, <span class="s">'visualization'</span>, <span class="s">'feature_importance'</span>)</span></div><div class="decorator"><span class="n">@tasks(<span class="s">'regression'</span>)</span></div>
