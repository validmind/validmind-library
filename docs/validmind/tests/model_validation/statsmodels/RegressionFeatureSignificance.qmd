...
<span class="kw">def</span><span class="name">RegressionFeatureSignificance</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">fontsize</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">int</span><span class="o">=</span><span class="kc">10</span><span class="muted">,</span></span><span class="params"><span class="n">p_threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- Mapping --><!-- ExprName --><span class="nb">float</span><span class="o">=</span><span class="kc">0.05</span></span>):
