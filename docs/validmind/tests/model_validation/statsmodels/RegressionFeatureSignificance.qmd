...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('statistical_test', 'model_interpretation', 'visualization', 'feature_importance')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('regression')</span></div>
