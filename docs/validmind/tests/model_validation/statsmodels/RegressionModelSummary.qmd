...
<span class="kw">def</span> <span class="name">adj_r2_score</span>(<span class="param"><span class="n">actual</span><span class="p">:</span><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span><span class="muted">,</span></span><span class="param"><span class="n">predicted</span><span class="p">:</span><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span><span class="muted">,</span></span><span class="param"><span class="n">rowcount</span><span class="p">:</span><span class="n">int</span><span class="muted">,</span></span><span class="param"><span class="n">featurecount</span><span class="p">:</span><span class="n">int</span></span>)</span>
...
<span class="kw">def</span> <span class="name">RegressionModelSummary</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><span class="n">VMDataset</span><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="p">:</span><span class="n">VMModel</span></span>)</span>
