...
<div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tags('visualization', 'credit_risk')</span></div><div class="decorator">@<!-- types.jinja2 - format_type --><span class="n">@tasks('classification')</span></div>
