...
<span class="kw">def</span><span class="name">integrate_diff</span>(<span class="param"><span class="n">series_diff</span><span class="muted">,</span></span><span class="param"><span class="n">start_value</span></span>):
...
<span class="kw">def</span><span class="name">RegressionModelSensitivityPlot</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a><span class="muted">,</span></span><span class="param"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a><span class="muted">,</span></span><span class="param"><span class="n">shocks</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">List</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">float</span><span class="p">\]</span><span class="o">=</span><span class="kc">{'cls': 'ExprList', 'elements': ['0.1']}</span><span class="muted">,</span></span><span class="param"><span class="n">transformation</span><span class="p">:</span><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type --><span class="n">Union</span><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="nb">str</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">None</span><span class="p">\]</span><span class="o">=</span><span class="kc">None</span></span>):
