...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">raise_api_error</span>(<span class="param"><span class="n">error_string</span></span>):</span> </span> :::
...
::: {.signature} <span class="signature pdoc-code multiline"> <span class="kw">def</span> <span class="name">should_raise_on_fail_fast</span>(<span class="param"><span class="n">error</span></span>) <span class="p">-></span> <span class="return-annotation">bool</span>:</span> </span> :::
