...
<span class="name">__init__</span>(<span class="params"><span class="n">message</span><span class="o">=</span><span class="s1">''</span></span>)
...
<span class="kw">def</span><span class="name">should_raise_on_fail_fast</span>(<span class="param"><span class="n">error</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><!-- DEBUG: ExprName --><span class="nb">bool</span><!-- DEBUG is_mapping: True -->
